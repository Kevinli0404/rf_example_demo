...
class _RenameFileDialog extends StatefulWidget {
  ...
  final Future<String?> Function(String)? validate;

  const _RenameFileDialog({required this.initialName, this.validate});
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 8.w),
            Text(label, style: AppTextStyle.medium16.copyWith(color: color)),
          ],
        ),
      ),
    );
